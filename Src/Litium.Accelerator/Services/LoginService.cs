...
namespace Litium.Accelerator.Services
{
    ...
    public abstract class LoginService
    {
        ...
        public abstract void SendNewPassword(Person user, string password, Guid channelSystemId, SecurityToken token);
        ...
        public abstract bool ChangePassword(Person user, bool mustChangePasswordAtNextLogon, bool sendNewPasswordEmailToUser, Guid channelSystemId, SecurityToken token);
        ...
        /// <param name="loginName">The user's login name</param>
        /// <param name="password">The user's password</param>
        /// <param name="token">The token which will be saved in the session.</param>
        /// <returns>True if the log in attempt was successful, otherwise false</returns>
        /// <exception cref="ChangePasswordException">Thrown if the user must change their password.</exception>
        public abstract bool Login(string loginName, string password, out SecurityToken token);
        ...
        /// <returns>True if the log in attempt was successful, otherwise false</returns>
        /// <exception cref="ChangePasswordException">Thrown if the user must change their password.</exception>
        public abstract bool Login(string loginName, string password, string newPassword, out SecurityToken token);
        ...
        public abstract bool IsValidLoginForm(ModelState modelState, LoginFormViewModel loginForm);
        ...
        /// <returns>True if the form is valid, otherwise false</returns>
        public abstract bool IsValidForgotPasswordForm(ModelState modelState, ForgotPasswordFormViewModel forgotPasswordForm);
